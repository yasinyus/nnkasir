...
class PembelianDetailController extends Controller
{
    public function index()
    {
        ...
        $produk = Produk::where('id_suplier', session('id_supplier'))->orderBy('nama_produk')->get();
        ...
        return view('pembelian_detail.index', compact('id_pembelian', 'produk', 'supplier', 'diskon', 'cabang'));
    }
