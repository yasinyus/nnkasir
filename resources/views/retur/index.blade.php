    ...
    <div class="col-lg-12">
        ...
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('{{ route('retur.data') }}')" class="btn btn-success btn-xl btn-flat"><i class="fa fa-plus-circle"></i> Cari Nota</button>
            </div>
            <form action="">
                ...
                <table class="table table-stiped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Rp. {{ format_uang($data->subtotal / $data->jumlah) }}</td>
                            <td>{{ $data->jumlah_retur }}</td>
                            <td>{{ $data->jenis_retur }}</td>
                            <td>{{ $data->alasan_retur }}</td>
                            <td>
